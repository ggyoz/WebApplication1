...
COMMENT ON TABLE TB_REQ_HIST IS '요청사항 히스토리';
...
COMMENT ON COLUMN TB_REQ_HIST.DUEDATE IS '완료요청일';
...
COMMENT ON COLUMN TB_REQ_HIST.SYSTEMCD IS '시스템';
COMMENT ON COLUMN TB_REQ_HIST.REQMENU IS '요청메뉴(영역)';
COMMENT ON COLUMN TB_REQ_HIST.REQMENU_ETC IS '기타메뉴';
COMMENT ON COLUMN TB_REQ_HIST.BXTID IS 'BXT 문의번호';
COMMENT ON COLUMN TB_REQ_HIST.REQUSERID IS '요청자';
COMMENT ON COLUMN TB_REQ_HIST.RESUSERID IS '조치자';
COMMENT ON COLUMN TB_REQ_HIST.IMPTCD IS '중요도';
...
COMMENT ON COLUMN TB_REQ_HIST.NOTE_HTML IS '조치 내역';
COMMENT ON COLUMN TB_REQ_HIST.NOTE_TEXT IS '조치 내역';
